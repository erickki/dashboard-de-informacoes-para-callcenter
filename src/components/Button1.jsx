export default function Button1(props) {
  ...
  return (
    <button className="h-[40px] w-[230px] relative overflow-hidden bg-purple-1 rounded-[25px] font-bold text-[16px] hover:text-[18px] text-white-1 hover:text-purple-1 duration-500 group">
